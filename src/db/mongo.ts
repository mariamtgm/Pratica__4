...
import { ConcessionaireSchema, SellerSchema, CarSchema } from "./schemas.ts";
...
export const carsCollection = db.collection<CarSchema>("Coches");
export const sellersCollection = db.collection<SellerSchema>("Vendedores");
export const ConcessionaireCollection = db.collection<ConcessionaireSchema>("Concesionarios");